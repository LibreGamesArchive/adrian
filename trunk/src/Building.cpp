...
static void wrappedglTexCoord2f(float x, float y)
{
...
void bunkerpole(float x1, float y1)
{
	...
	wrappedglTexCoord2f(0.5, 1);
	glVertex3f(x1, h, y1);
	wrappedglTexCoord2f(0.0, 0.0);
	glVertex3f(x1 - 5, 0, y1 + 5);
	wrappedglTexCoord2f(0.5, 0.0);
	glVertex3f(x1 + 5, 0, y1);
	wrappedglTexCoord2f(1.0, 0.0);
	glVertex3f(x1 - 5, 0, y1 - 5);
	wrappedglTexCoord2f(0.0, 0.0);
	glVertex3f(x1 - 5, 0, y1 + 5);
	glEnd();
	...
	case 10:		//WALL VERTICAL
		{
			...
			glBegin(GL_POLYGON);
			wrappedglTexCoord2f(0, 0);
			glVertex3f(x1, 0, y1);
			wrappedglTexCoord2f(0, 1);
			glVertex3f(x1, h, y1);
			wrappedglTexCoord2f(xr, 1);
			glVertex3f(x2, h, y1);
			wrappedglTexCoord2f(xr, 0);
			glVertex3f(x2, 0, y1);
			glEnd();
			...
			wrappedglTexCoord2f(0, 1);
			glVertex3f(x1, h, y1);
			wrappedglTexCoord2f(yr, 1);
			glVertex3f(x1, h, y2);
			wrappedglTexCoord2f(yr, 0);
			glVertex3f(x1, 0, y2);
			glEnd();
	...
	case 9:		//GB general's building
		{
			...
			//DOOR
			glBegin(GL_POLYGON);
			wrappedglTexCoord2f(0.5, 0.5);
			glVertex3f(x2, 0, y1);
			wrappedglTexCoord2f(0.5, 1.0);
			glVertex3f(x2, h, y1);
			wrappedglTexCoord2f(0.0, 1.0);
			glVertex3f(x2, h, y2);
			wrappedglTexCoord2f(0.0, 0.5);
			glVertex3f(x2, 0, y2);
			glEnd();
			...
			wrappedglTexCoord2f(0.5, 0.45);
			glVertex3f(x2 + 120, h, y2);
			wrappedglTexCoord2f(0.0, 0.45);
			glVertex3f(x1, h, y2);
			glEnd();
			glBegin(GL_POLYGON);
			wrappedglTexCoord2f(0.0, 0.5);
	...
	case 11:		//MANY CRATE crate this should be four grid size
		{
			...
			wrappedglTexCoord2f(0, 1);
			glVertex3f(x1, h, y1);
			wrappedglTexCoord2f(1, 0);
			glVertex3f(x2, 0, y1);
			wrappedglTexCoord2f(1, 1);
			glVertex3f(x2, h, y1);
			wrappedglTexCoord2f(0, 0);
			glVertex3f(x2, 0, y2);
			wrappedglTexCoord2f(0, 1);
...
//                              wrappedglTexCoord2f(0.65,0.65);
			glVertex3f(cx + tr2, h, cy + tr2);
//                              wrappedglTexCoord2f(1.0,0.5);
			glVertex3f(cx + r2, h, cy);
//                              wrappedglTexCoord2f(0.65,0.35);
			glVertex3f(cx + tr2, h, cy - tr2);
//                              wrappedglTexCoord2f(0.5,0.0);
			glVertex3f(cx, h, cy - r2);
//                              wrappedglTexCoord2f(0.35,0.35);
			glVertex3f(cx - tr2, h, cy - tr2);
//                              wrappedglTexCoord2f(0.0,0.5);
			glVertex3f(cx - r2, h, cy);
//                              wrappedglTexCoord2f(0.35,0.65);
			glVertex3f(cx - tr2, h, cy + tr2);
			glEnd();
	...
	case 5:		//TANK
		{
			...
			glColor3f(1, 1, 1);
			glBegin(GL_POLYGON);
			wrappedglTexCoord2f(.5 + texw, .5);
			glVertex3f(curx + w, h, cury);
			wrappedglTexCoord2f(.5 + texw2, .5 + texw2);
			glVertex3f(curx + w2, h, cury + w2);
			wrappedglTexCoord2f(.5, .5 + texw);
	...
	case 1:
		...
		//TOP
		glBegin(GL_POLYGON);
		wrappedglTexCoord2f(.25, 0);
		glVertex3f(x1, h, y1);
		wrappedglTexCoord2f(.25, .75);
		glVertex3f(x1, h, y2);
		wrappedglTexCoord2f(.70, .75);
		glVertex3f(x2, h, y2);
		wrappedglTexCoord2f(.70, 0);
		glVertex3f(x2, h, y1);
		glEnd();
		glDisable(GL_TEXTURE_2D);
